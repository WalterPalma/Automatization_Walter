-------------------------- Automatização de Testes ------------------------------
 Para executar o  programa basta fazer o download por meio do comando git clone
 
 - git clone https://github.com/WalterPalma/Automatization_Walter.git 
 
 1) É necessário ter o navegador Firefox instalado (73.0.1)
 2) Verifique seus os arquivos da pasta "driver" foram baixados corretamente
